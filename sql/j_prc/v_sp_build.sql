...
begin
	...
	raise notice e'player id 202270 insert complete: %s\n', fn_cntstr('lg.plr');
	...
	call stats.sp_pbox();
	raise notice e'pbox insert complete: %s\n', fn_cntstr('stats.pbox');
